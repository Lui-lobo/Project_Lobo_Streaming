...
import { Container, Frame, Item, Title, Header, Body , Inner} from './styles/accordion';
...
Accordion.Header = function AccordionHeader({ children, ...restProps}) {
    ...
    return (<Header onClick={() => setToggleShow((toggleShow) => !toggleShow)} {...restProps}>
         {children} 
         {toggleShow ? (<img src="/images/icons/close-slim.png" alt="Close" />): (<img src="/images/icons/add.png" alt="open"></img>)}
         </Header>);
};
